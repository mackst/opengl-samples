...
class Window(object):
    ...
    def __init__(self, width=640, height=480, title='GLFW opengl window'):
        ...
        self.__vertexShader = './shaders/01shader_vbo2.vert'
        self.__fragmentShader = './shaders/01shader_vbo2.frag'
    ...
    def initGL(self):
        ...
        glBindAttribLocation(self.__shaderProgram, 0, 'vposition')
        glBindAttribLocation(self.__shaderProgram, 1, 'vcolor')

        # bind the FragDataLocation (output)
        glBindFragDataLocation(self.__shaderProgram, 0, 'FragColor')
